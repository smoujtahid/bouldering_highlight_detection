...
def infer_long_video(video_path, query_list):
    """
    Args:
        video_path: str, path to the video file
        query_list: list of str queries
    ...
    for start_id in range (0, n_total_frames, step):
        ...
        moment_detr_predictor.pretty_print_pred(outputs_segment, query_list, 0.8)
        ...
        for i,_ in enumerate(query_list):
            ...
            predicted_moments[i].append(outputs_segment[i]["pred_relevant_windows"])
...
if __name__ == "__main__":
    ...
    query_text_list = ["a climber making a jump", "a crowd cheering"]
